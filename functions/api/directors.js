...
const SELECT = 'id,name,town,postcode,lat,lng,attended_price,cremation_price,nafd_member,saif_member,is_featured,last_updated,google_rating,google_reviews,claimed_at,photos'
const PAGE   = 1000
