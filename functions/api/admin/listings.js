...
export async function onRequestGet(context) {
  ...
  const res = await fetch(
    `${SUPABASE_URL}/rest/v1/funeral_directors?or=(is_featured.eq.true,needs_review.eq.true)&select=id,name,town,website,director_email,is_featured,needs_review,photos,pending_photos&order=needs_review.desc,name.asc`,
    {
